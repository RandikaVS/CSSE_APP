    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.nav_menu_item_profile:
                ...
                overridePendingTransition(0,0);
                break;
            case R.id.nav_menu_item_create_pr:
                startActivity(new Intent(this,FindSupplier.class));
                overridePendingTransition(0,0);
                break;
            case R.id.nav_menu_item_requisite_orders:
                startActivity(new Intent(this,RequisiteOrders.class));
                overridePendingTransition(0,0);
                break;
